            ...
            <div class="header-sections">
                <div class="menu-section">
                    <div class="menu-items">
                        ...
                        <div class="menu-item flex align-center" route-page="/discography">
                            <div class="menu-icon podcast"></div>
                            <div class="menu-label">Discografia</div>
                        </div>
                        <div class="menu-item flex align-center" route-page="/radioshow">
                            <div class="menu-icon programs"></div>
                            <div class="menu-label">Radioshow</div>
                        </div>
                        <div class="menu-item flex align-center" route-page="/bio">
                            <div class="menu-icon contact"></div>
                            <div class="menu-label">Bio</div>
                        </div>
                ...
                <div class="menu-section">
                    <div class="dflex row-dir align-center">
                        ...
                        <div class="s-icons dflex row-dir align-center" style="margin:0 auto">
                            <a class="icon" href="<?= FACEBOOK_LINK; ?>" target="_blank">
                            ...
                            <a class="icon" href="<?= INSTAGRAM_LINK ?>" target="_blank">
                            ...
                            <div class="horizontal-sep-2"></div>
                            <a class="icon" href="<?= TIKTOK_LINK ?>" target="_blank">
                                <div class="social-link tiktok" style="font-size: 16px;color: #2a2a2a;"></div>
                            </a>
                        </div>
                    </div>
                    <div class="hor-bar"></div>
                ...
                <div class="menu-section">
                    <div class="mh-wrapper">
                        <div class="small-text">
                            <span>&copy; 2024 / 2025 djsannyjofficial.it</span>
                        </div>
                        <div class="small-text">
