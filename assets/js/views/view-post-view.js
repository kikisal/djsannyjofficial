...
((m) => {
    ...
    function ytembed(yturl) {
        ...
        iframeWrapper.innerHTML = `<iframe style="width: 100%; height: 100%" src="${yturl}?autoplay=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>`;
    ...
    class ViewPostPage {
        ...
        constructor(elementQuery) {
            ...
            this._videoArea          = this._page.querySelector('.video-area');
        ...
        onFeedFetched(feed) {
            ...
            if (!(!!feed.video_file_url)) {
                ...
                if (!feed.video_urls) {
                    ...
                    this._postImage.classList.add('_hide');
                    this._videoArea.appendChild(ytembed(feed.video_urls));
                }
            } else {
                this._postImage.classList.add('_hide');
                this._videoArea.appendChild(videoFile(feed.video_file_url)).play();
            }
