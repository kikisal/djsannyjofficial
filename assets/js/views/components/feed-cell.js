((m) => {
    ...
    class PlayVideoComponent extends CustomComponent {
        constructor(props) {
            super();
        }

        onViewCreated() {
            this.setClassList(['fc-video-play-wrapper']);
        }

        render() {
            return this.markup_builder({
                component: 'div',
                classList: ['fc-video-play-icon'],
                children: [
                    {
                        component: 'div',
                        classList: ['fc-video-play-button'],
                        children: [
                            {
                                component: 'div',
                                classList: ['fc-video-play-icon-css']
                            }
                        ]
                    },
                    {
                        component: "div",
                        classList: ['fc-timeline-bar'],
                        children: [
                            {
                                component: "div",
                                classList: ['fc-timeline-ball']
                            }
                        ]
                    },
                    {
                        component: "div",
                        classList: ['fc-video-play-label-text'],
                        children: [
                            {
                                component: "span",
                                textContent: "video"
    ...
    class PlaybackComponent extends CustomComponent {
        constructor({videoUrl, audioUrl}) {
            super();
            this._videoUrl = videoUrl;
            this._audioUrl = audioUrl;
            this._hasVideo = !!this._videoUrl;
        }
            ...
            */
            ...
            if (this._hasVideo) {
                this.markup_builder({
                    component: 'div',
                    children: [
                        this.markupComponent(PlayVideoComponent)
                    ],
                    extractAll: true
                })
            } else {
                this.markup_builder({
                    ...
                    extractAll: true,
                    children: [
                        (!!this._audioUrl) ? this.markupComponent(PlayComponent, {
                        ...
                        children: [
                            {
                                ...
                                loading: "lazy",
                                events: {
                                    "load": [(e, img) => { img.classList.add('--img-loaded'); }]
                                },
                                attribs: {
                                    animate: ''
                                }
                            },
                            this.markupComponent(PlaybackComponent, {
                                videoUrl:  this.getPostData().video_file_url,
                                audioUrl:  this.getPostData().audio_url
                            })
                        ]
                    },
    ...
    class BigFeedCell extends FeedCell {
        ...
        onViewCreated() {
            this.setClassList(['news-item', 'flex-shrink-0', 'br-3']);
            super.onViewCreated();
        }
